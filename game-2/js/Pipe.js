(function () {
  ...
  Pipe.prototype.render = function () {
    game.draw.drawImage(game.allImg['pipe_down'], 0, 320 - this.height, 52, this.height, this.x, 0, 52, this.height);
    game.draw.drawImage(game.allImg['pipe_up'], 0, 0, 52, this.h, this.x, this.height + this.space, 52, this.h);
  };
